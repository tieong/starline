...
export const influencers: Influencer[] = [
  ...
  },
  {
    ...
    name: 'EnjoyPhoenix',
    handle: '@EnjoyPhoenix',
    avatar: '/avatars/enjoyphoenix.jpeg',
    followers: 3900000,
    engagementRate: 6.8,
